...
export default function BlogPage() {
  ...
  return (
    <main className="bg-background pt-32 pb-24 px-6 md:px-12 lg:px-24 overflow-x-hidden">
          ...
          <>
            ...
            {featuredPost && (
              <motion.section 
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8 }}
                className="relative h-[600px] md:h-[700px] rounded-md overflow-hidden group"
              >
                <img 
